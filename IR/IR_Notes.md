...
2. once the IR merging is finalized, update the [final labels](https://github.com/felicitia/UsageTesting-Repo/blob/master/IR/final_labels_all.csv) with respect to the IR merging changes
