...
def generate_typing_results(usage_root_dir):
    ...
    checkpoint = torch.load('/Users/yixue/Documents/Research/UsageTesting/UsageTesting-Repo/code/binaryClassifier/model_cifar.pt') #Update the saved model location
